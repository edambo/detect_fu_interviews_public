...
This file builds on [the previous Quarto document](), which performed fastLink fuzzy-matching of subjects in the APS and MedStar data sets. This file documents the review of pairs and ID assignments for between-set subject-level matching.
