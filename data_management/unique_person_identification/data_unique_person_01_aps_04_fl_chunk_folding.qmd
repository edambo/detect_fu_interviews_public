...
-   Reduced 378,418 `client_id` values to 371,072 `aps_id` values, a 1.941% reduction.
...
We performed a final QC check of our newly assigned unique subject IDs. We identified several rows which required revision, most frequently due to lingering spousal/familial matches.
