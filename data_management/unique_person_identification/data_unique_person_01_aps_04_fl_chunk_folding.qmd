...
-   Reduced 378,418 `client_id` values to  371,975 `aps_id` values, a 1.967% reduction..
...
This map reduced our unique subject IDs from 378,418 `client_id` values to  371,975 `aps_id` values, a 1.967% reduction.
...
# [1] "Reduced 378,418 client_id values to 370,975 aps_id values, a 
# 1.967% reduction."
```
