...
aps <- aps |>
  ...
  dplyr::mutate(
    ...
    client_street_address_name = ifelse(
      case_id %in% checking$case_id &
        client_street_address %in% point_fixes$original_value,
        dplyr::case_when(
          client_street_address == point_fixes$original_value[1] ~ 
            point_fixes$name[1],
          TRUE ~ client_street_address_name
        ),
        client_street_address_name
    ...
    client_street_address_name = ifelse(
      case_id %in% checking$case_id &
        ...
        dplyr::case_when(
          client_street_address == point_fixes$original_value[1] ~ 
            point_fixes$name[1],
          client_street_address == point_fixes$original_value[2] ~ 
            point_fixes$name[2],
          TRUE ~ client_street_address_name
        ),
        client_street_address_name
