...
There were 14,615 rows remaining with street address values containing one of our chosen components.
...
checking <- aps |>
  dplyr::filter(
    stringr::str_detect(
      client_street_address, 
      paste0('(county road|country road|cnty| cr |-cr|',
             'cr rd|cr road|county rd|country rd)'
           )
      )
  )
...
###### Standardization of County Road Values

We chose to standardize all "County Road" variants to "CR".

[CODE PLACEHOLDER - AUBERGINE]
