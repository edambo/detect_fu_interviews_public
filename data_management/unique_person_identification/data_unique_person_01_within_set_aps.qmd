...
Mr., Ms., Mrs., and Dr. are the primary titles used in the US. Sr. and Sra. are common Spanish-language titles used in the US. 
```{r}
target_regex <- "^((mrs)|(sra)|(ms)|(mr)|(sr)|(dr))[^a-z]?"
