...
There were several observations identified in prior examination and standardization which referenced farm to market. While roads are formally standardized to "FM" according to [USPS standards](https://pe.usps.com/text/pub28/28apf.htm), we chose to standardize to "FTM" to reduce non-significant string distances and any ambiguity in targetting these entries. We identified the following values as likely referencing "farm to market road" in addressing: farm, market, ftm, and fm.
