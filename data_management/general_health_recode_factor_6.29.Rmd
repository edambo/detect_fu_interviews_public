---
title: "general_health_recode_factor"
...
general_health <- read_csv("General Health.csv")
...
Encoding(general_health$outcomes_health_general) <- "ASCII"
Encoding(general_health$outcomes_health_unable) <- "ASCII"
Encoding(general_health$outcomes_health_keep) <- "ASCII"
Encoding(general_health$auditc_drink) <- "ASCII"
Encoding(general_health$auditc_day) <- "ASCII"
Encoding(general_health$auditc_five) <- "ASCII"
...
general_health <- general_health %>%
  mutate(
    across(
      ...
      .fns   = ~ factor(.x, labels = c("0 - No pain", "1", "2", "3", "4", "5",
                                    "6", "7", "8", "9", 
...
```{r}
write_csv(general_health, "general_health_factor.csv")
