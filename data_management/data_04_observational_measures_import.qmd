---
title: "data_05_observational_measures_import.qmd"
format: html
---
...
```{r}
observational_measures_import.csv <- file.choose()
obs_meas <- read_csv(observational_measures_import.csv)
