---
title: "data_01_merged_data_codebook"
format: html
---
...
lpc_vars <- detect_fu_merge %>% 
  select(ends_with("_lpc")) %>%
  names()
...
no_stats <- detect_fu_merge %>%
  select(
    unique_id_par, x_created_by_par, x_created_timestamp_par, name_first_par, name_middle_initial_par, name_last_par, medstar_id, name_full_par, x_address_original_par, city_par, state_par, zip_code_par, name_suffix_par, x_primary_key_par, x_modified_by_par, x_modified_timestamp_par, x_record_status_par, phone_par, x_record_month_par, x_record_year_par, x_error_message_par, dob_par, x_randomizer_par, x_call_order_par, incident_timestamp_par, unit_arrived_timestamp_par, ems_response_number_par, medstar_internal_id_par, complaint_reported_par, incident_result_par, ems_crew_member_par, symptom_list_par, xc_incident_day_name_par, xc_incident_month_name_par, xc_incident_day_par, xc_incident_year_par, xc_record_month_year_abbr_par, x_is_archived_par, apt_par, address_par, x_usps_address_result_par, x_address_verified_par, x_call_order_initial_par, x_exclusion_reason_par, xc_case_id_par, xc_call_order_even_odd_par, xc_participant_list_found_count_par, x_aps_reported_confirmation_number_par, xc_name_title_par, address_valid_par, address_updated_par, apt_updated_par, city_updated_par, zip_code_updated_par, xc_address_par, xc_incident_date_par, xc_detect_positive_summary_count_par, x_created_by_aps, x_created_timestamp_aps, x_modified_by_aps, x_modified_timestamp_aps, x_record_status_aps, x_error_message_aps, x_record_month_aps, x_record_year_aps, x_record_comment_aps, xc_lead_panel_summary_count_aps, x_created_by_cls, x_created_timestamp_cls, x_modified_by_cls, x_modified_timestamp_cls, x_error_message_cls, x_record_status_cls, x_record_month_cls, x_record_year_cls, x_record_comment_cls, x_created_by_glh, x_created_timestamp_glh, x_modified_by_glh, x_modified_timestamp_glh, x_error_message_glh, x_record_status_glh, x_record_month_glh, x_record_year_glh, x_record_comment_glh, x_created_by_lpc, x_created_timestamp_lpc, x_modified_by_lpc, x_modified_timestamp_lpc, x_record_month_lpc, x_record_year_lpc, x_record_status_lpc, x_record_comment_lpc, x_error_message_lpc, x_username_lpc, comments_lpc, x_assessment_month_lpc, x_assessment_year_lpc, xc_join_lpc, x_created_by_obs, x_created_timestamp_obs, x_modified_by_obs, x_modified_timestamp_obs, x_error_message_obs, x_record_status_obs, x_record_month_obs, x_record_year_obs, x_record_comment_obs, xc_lead_panel_summary_count_obs, xc_lead_panel_summary_comment_count_obs, xc_lead_panel_summary_obs, neglect_comments_obs, exploitation_comments_obs, abandonment_comments_obs, summary_comments_obs, general_assessment_comments_obs, abuse_indicators_comments_obs, at_phys_why_obs, at_sex_why_obs, at_emot_why_obs, at_neg_why_obs, at_aban_why_obs, at_fina_why_obs, at_self_why_obs, aps_reported_confirmation_number_obs, x_created_by_sfr, x_created_timestamp_sfr, x_modified_by_sfr, x_modified_timestamp_sfr, x_record_status_sfr, x_error_message_sfr, xc_lead_panel_summary_count_sfr, x_record_month_sfr, x_record_year_sfr, x_record_comment_sfr, xc_emotional_list_sfr, xc_physical_list_sfr, xc_sexual_list_sfr, x_created_by_soc, x_created_timestamp_soc, x_modified_by_soc, x_modified_timestamp_soc, x_record_status_soc, x_error_message_soc, x_record_month_soc, x_record_year_soc, x_record_comment_soc
    )
...
detect_fu_merge <- detect_fu_merge %>%
    ...
    cb_add_col_attributes( 
      outcomes4_weeks_pain_8cat_f_glh, 
      description = "MO_1. How much bodily pain have you had during the past 4 weeks?"
    ) %>%
...
detect_fu_merge <- detect_fu_merge %>%
    ...
    cb_add_col_attributes( 
      abandonment_2cat_f_lpc, 
      description = "If LEAD panel user thought abandonment occurred"
    ) %>%

    cb_add_col_attributes( 
      financial_exploitation_2cat_f_lpc, 
      description = "If LEAD panel user thought financial or material exploitation occurred"
    ) %>%

    cb_add_col_attributes( 
      self_neglect_2cat_f_lpc, 
      description = "If LEAD panel user thought self-neglect occurred"
    ) %>%
    ...
    cb_add_col_attributes( 
      panelist_discipline_5cat_f_lpc, 
      description = "Panelist's professional discipline"
    ) %>%
  
    cb_add_col_attributes( 
      healthcare_worker_2cat_f_lpc, 
...
```{r}
print(detect_fu_merged_codebook, "detect_fu_merge_codebook.docx")
```
