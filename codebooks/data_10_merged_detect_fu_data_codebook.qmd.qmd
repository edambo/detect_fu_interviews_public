...
detect_fu_merge <- detect_fu_merge %>%
  ...
  cb_add_col_attributes(
    ...
    description = "Question used in older version of the follow-up interview until"
  ) %>%
  cb_add_col_attributes(
    physical_hit_age_sfr,
    description = "How old were you when this happened (most recently)? (Question used in older version of the follow-up interview until.)"
  ) %>%
  cb_add_col_attributes(
