...
observational_measures <- obs %>%
    ...
    cb_add_col_attributes( 
     ...
     cb_add_col_attributes( 
       ...
       description = "Calculated count of comments on positive abuse instances across SelfReport, ApsInvestigations, and ObservationalMeasures comments"
     ) %>%
    
     cb_add_col_attributes( 
       xc_lead_panel_summary, 
       description = "Summary of positive abuse instances across SelfReport, ApsInvestigations, and ObservationalMeasures"
     ) %>%
...
```{r}
print(obs_meas_codebook, "data_01_observational_measures_codebook.docx")
```
