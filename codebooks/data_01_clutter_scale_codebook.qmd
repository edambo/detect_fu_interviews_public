---
title: "data_01_clutter_scale_codebook"
format: html
---
...
```{r}
#| warning: false
clutter_scale_import.rds <- file.choose()
clutter_scale <- readRDS("clutter_scale_import.rds")
```

# Glimpse data with every column shown
```{r}
glimpse(clutter_scale)
```
...
```{r}
print(clutter_scale_codebook, "data_01_clutter_scale_codebook.docx")
```