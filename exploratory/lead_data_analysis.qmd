...
This data was collected by MedStar at the initial 911 response. It includes the results of the intitial DETECT screening. We will need those screening results below to compare with LEAD panel findings. 
...
Add quick description of where this data comes from and how it was collected. Also, why do we need it.
...
Add quick description of where this data comes from and how it was collected. Also, why do we need it. If this is the DETECT tool filled out at the follow-up interview, I think we will also want the results of the DETECT tool filled out at the initial 911 call. Because we want to be able to say, "At the inital 911 response the DETECT tool was [positive/negtive] for EM. The lead panel then reviewed the case and determined that EM [was/was not] occuring. X porportion of the time, the initial DETECT screening and the LEAD panel determination agreed with each other."
...
Add a quick description of what this is doing and why.
...
Also, the code below has a lot of repetition. This woulb be a good opportunity to practice writing a function that we can apply to all three dfs. 
