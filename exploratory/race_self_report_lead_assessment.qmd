...
Ebie, please create the numeric verisons of these variables in the same file where you are cleaning this data. 

```{r}
# Create dummy variables for abuse determinations
lpa <- lpa %>%
  mutate(
...
## Number and proportion of assessements compelted by type of assesement
...
## Positive determinations overall - Initial assessment
...
## Positive determinations overall
